...
cap rename locatıon location
cap rename tıme time

keep location time transact sector value
reshape wide value, i(location time transact) j(sector) string
reshape wide value*, i(location time) j(transact) string
...
cap rename ındicatorcode indicatorcode
cap rename ındicatorname indicatorname
...
reshape wide value, i(ifsid year) j(indicatorcode) string
...
keep year iso share_foreign
save "C:\Users\cemun\Research_local\icai2022\data\data_dta\share_foreign_wid.dta"
/*
